...
var toNativeData = {			// [사용 함수명]   	설명
	...
	fileId : null,				// [onDeleteImage, onImageEdit] 	onOpenGallery에서 넘겨받은 선택 한 사진에 대한 fileId
	type : null,				// [onNewPage] 		TV(펫 TV), LIVE(라이브 영상) 
								// [onMainPage] 	TV(펫 TV), LOG(펫 로그), SHOP(펫 샵)
								// [onAutoPlay]		MW(모바일 + Wi-Fi), W(Wi-Fi), N(사용안함)
	url : null,					// [onNewPage, onExtBrowser, onOrderPage, onShowPG, onHistoryBack, onAddHistory, onReplaceHistory] 		이동할 주소(Full Address)
	...
	callback : null,			// [onOpenGallery, onCurrentLoc, onNetworkStatus, onSettingInfos, onFileUpload, onPushToken, onImageEdit, onIsAutoPlay, onClosePassingData, onBackSelected] callback 함수명
